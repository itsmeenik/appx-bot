...
# Flask setup for Render uptime 24/7
...
# Direct credentials set taaki token error na aaye
API_ID = 35160648
...
bot = TelegramClient('appx_session', API_ID, API_HASH).start(bot_token=BOT_TOKEN)
user_data = {}
